...
<ul>
  ...
  <li>Uma grande <strong>célula-mãe de megásporo</strong> (2n), que sofre meiose e origina quatro células (n):
    <ul>
      <li>Três se <strong>degeneram</strong>;</li>
      <li>Uma se transforma no <strong>megásporo funcional</strong> (n).</li>
    </ul>
  </li>
</ul>
...
<ul>
  ...
  <li>Duas <strong>sinérgides</strong>;</li>
  <li>Três <strong>antípodas</strong>;</li>
...
<ol>
  ...
  <li>O outro <strong>núcleo espermático (n)</strong> se une aos <strong>dois núcleos polares (n + n)</strong>, formando um <strong>núcleo triploide (3n)</strong> → este originará o <strong>endosperma secundário</strong>, que nutre o embrião.</li>
</ol>
...
<ul>
  ...
  <li>O <strong>endosperma secundário + embrião</strong> formam a <strong>semente</strong>;</li>
...
<div class="text-center">
    <h1>Esquema de reprodução das das angiospermas</h1>
    <img class="img-fluid" src="https://i.postimg.cc/fRyzLJB1/20190711-angiospermas-ciclo-2.jpg" alt="ciclo de reprodução das angiospermas">
</div>
